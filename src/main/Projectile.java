...
public class Projectile extends MovingObject {
    ...
    public Projectile(MovingObject movingObject) {
        if(movingObject instanceof Player){
            player = (Player) movingObject; // IF SATS OCH KOLLA VAD FÖR SUBKLASS
        ...
        if(movingObject instanceof Alien){
            alien = (Alien) movingObject; // IF SATS OCH KOLLA VAD FÖR SUBKLASS
